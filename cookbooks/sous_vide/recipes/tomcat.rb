# This is an example cookbook taken directly from official Tomcat cookbook at
# 
# https://github.com/chef-cookbooks/tomcat/blob/master/test/cookbooks/test/recipes/helloworld_example.rb
#
# Used for demonstration of purposes only.
...
cookbook_file '/opt/tomcat_helloworld/conf/server.xml' do
  ...
  group 'root'
  mode '0644'
  notifies :restart, 'tomcat_service_sysvinit[helloworld]'
end
...
tomcat_service_sysvinit 'helloworld' do
  action [:start, :enable]
